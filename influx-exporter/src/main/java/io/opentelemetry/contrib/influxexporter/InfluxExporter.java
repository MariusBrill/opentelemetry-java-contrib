...
/**
 * This class resembles an InfluxDB Exporter for OpenTelemetry. It is based on the {@link
 * InfluxDBClient}. To instantiate this class, use {@link InfluxExporterBuilder}.
 */
@ThreadSafe
public final class InfluxExporter implements MetricExporter {
   ...
   * @return Returns {@link CompletableResultCode#FAILURE} if an exception occurred during
   *     exporting.
   */
  @Override
