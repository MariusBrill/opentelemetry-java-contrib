...
public class InfluxExporterTest {
  ...
  void exportDoubleGaugeData() {
    ...
    Point expectedDataPoint = new Point("double_gauge_test")
        .addField("value",1.0)
        .addTag("k", "v")
        .time(200L, WritePrecision.NS);
    verify(mockWriteApiBlocking).writePoint(argument.capture());
    //We compare the LineProtocols here because Point is a read only class and the LineProtocol contains all parameters.
  ...
  void exportLongGaugeData() {
    ...
    Point expectedDataPoint = new Point("long_gauge_test")
        .addField("value",4L)
        .addTag("k", "v").time(200L, WritePrecision.NS);
    verify(mockWriteApiBlocking).writePoint(argument.capture());
    //We compare the LineProtocols here because Point is a read only class and the LineProtocol contains all parameters.
    assertEquals(expectedDataPoint.toLineProtocol(), argument.getValue().toLineProtocol());
  ...
  void exportDoubleSumData() {
    ...
    Point expectedDataPoint = new Point("double_sum_test")
        .addField("value",2.0)
        .addTag("k", "v")
        .time(200L, WritePrecision.NS);
    verify(mockWriteApiBlocking).writePoint(argument.capture());
  ...
  void exportLongSumData() {
    ...
    Point expectedDataPoint = new Point("long_sum_test")
        .addField("value",3L)
        .addTag("k", "v")
        .time(200L, WritePrecision.NS);
    verify(mockWriteApiBlocking).writePoint(argument.capture());
  ...
  void exportHistogram() {
    ...
    Point expectedDataPoint = new Point("histogram_test")
        .addField("count",10)
        .addField("max",5.0)
        .addField("min",5.0)
        .addField("sum",5.0)
  ...
  void exportSummary() {
    ...
    Point expectedDataPoint1 = new Point("summary_test")
        .addField("count", 6).addField("sum",6.0)
        .addTag("k", "v")
        .time(200L, WritePrecision.NS);
    Point expectedDataPoint2 = new Point("summary_test")
    ...
    return ImmutableMetricData.createDoubleGauge(Resource.empty(),
        ...
        ImmutableGaugeData.create(Collections.singletonList(
            ImmutableDoublePointData.create(
                1L, 200L, Attributes.of(stringKey("k"), "v"), 1))));
  }

  static MetricData generateDoubleSumData() {
    ImmutableDoublePointData data = (ImmutableDoublePointData) ImmutableDoublePointData.create(1L, 200L, Attributes.of(stringKey("k"), "v"), 2);
    List<DoublePointData> dataList = Collections.singletonList(data);
    ImmutableSumData<DoublePointData> sumData = ImmutableSumData.create(/* isMonotonic= */ true,
        AggregationTemporality.CUMULATIVE,
        dataList);
    return ImmutableMetricData.createDoubleSum(Resource.empty(),
        InstrumentationScopeInfo.empty(),
        "double_sum_test",
        "description",
        "1",
        ...
        ImmutableSumData.create(
            ...
            Collections.singletonList(
                ImmutableLongPointData.create(
                    1L, 200L, Attributes.of(stringKey("k"), "v"), 3))));
  }

  static MetricData generateLongGauge() {
    return ImmutableMetricData.createLongGauge(Resource.empty(),
        InstrumentationScopeInfo.empty(),
        "long_gauge_test",
        "description",
        "1",
        ImmutableGaugeData.create(Collections.singletonList(
            ImmutableLongPointData.create(
                1L, 200L, Attributes.of(stringKey("k"), "v"), 4))));
  }
  ...
  static MetricData generateHistogram() {
    ...
    ImmutableHistogramPointData pointData =  ImmutableHistogramPointData.create(1L, 200L, Attributes.of(stringKey("k"), "v"), 5.0, 5.0, 5.0,
        boundaries, counts);
  ...
  static MetricData generateSummary() {
    return ImmutableMetricData.createDoubleSummary(
        ...
        "description",
        "1",
        ImmutableSummaryData.create(Collections.singletonList(ImmutableSummaryPointData.create(
            1L,
            200L,
